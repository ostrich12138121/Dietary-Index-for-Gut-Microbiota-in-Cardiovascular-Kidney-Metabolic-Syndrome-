...
# ===== 心血管死亡 OOF =====
RSF_CV_OOF = r"D:\python\food\cvdeath\RSF_no_year_5fold_oof_predictions.csv"
...
plot_km_by_risk(
    ...
    title="Risk-stratified curves by RSF OOF prediction (Cardiovascular mortality)",
    save_name="Figure_KM_RSF_CVDeath.png"
)
...
plot_km_by_risk(
    ...
    title="Risk-stratified curves by XGBoost OOF prediction (Cardiovascular mortality)",
    save_name="Figure_KM_XGB_CVDeath.png"
)